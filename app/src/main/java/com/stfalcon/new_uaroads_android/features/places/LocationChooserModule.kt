...
class LocationChooserModule {
    ...
    @Provides
    fun providePresenterLoader(context: Context, presenter: LocationChooserPresenter)
            : PresenterLoader<LocationChooserContract.Presenter> = PresenterLoader(context, presenter)
