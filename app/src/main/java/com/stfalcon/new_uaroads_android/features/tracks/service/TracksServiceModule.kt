 ...
 */
@Module
class TracksServiceModule {

    @Provides
    fun provideTracksRepo(service: TracksService, dataUtils: DataUtils, context: Context):
            TracksRepo = TracksRepoImpl(service, dataUtils, context)
